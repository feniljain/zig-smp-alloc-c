...
readonly alloc_all="sys dh ff fg gd hd hm hml iso je lf lp lt mi mi-sec mi2 mi2-sec mng mesh nomesh pa rp sc scudo sg sm sn sn-sec tbb tc tcg mi-dbg mi2-dbg xmi xsmi xmi-dbg yal zsmp"
...
alloc_lib_add "zsmp"   "/home/feniljain/Projects/zig-projects/smp-alloc/zig-out/lib/libsmp_alloc.so"
